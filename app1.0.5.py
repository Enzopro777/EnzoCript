...
def encrypt_file_v2(input_path, pub_key_path, output_path,
    ...
    with open(input_path,"rb") as fin, open(output_path,"wb") as fout:
        # Se construye y se guarda la cabecera
        ...
        while True:
            ...
            # Se usa el header completo para el AAD de cada chunk
            ct_tag = aesgcm.encrypt(nonce, pt, _aad(idx, header))
    ...
    with open(container_path,"rb") as fin:
        ...
        with open(fp,"wb") as fout:
            while True:
                ...
                # Se valida contra el header en cada chunk
                try:    pt = aesgcm.decrypt(nonce, ct+tag, _aad(idx, header))
